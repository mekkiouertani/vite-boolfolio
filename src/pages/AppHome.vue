                        ...
                        <div class="col-xxl-5">
                            ...
                            <div class="text-center text-xxl-start">
                                ...
                                <div
                                    ...
                                    <a @click="selectView('resume')"
                                        class="btn btn-primary btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder" href="#">Resume</a>
                                    <a @click="selectView('projects')"
                                        class="btn btn-outline-dark btn-lg px-5 py-3 fs-6 fw-bolder" href="#">Projects</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xxl-7">
                            ...
                            <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                                <div class="profile bg-gradient-primary-to-secondary">
                                    ...
                                    <img class="profile-img" src="../assets/images/profile2.png" alt="..." />
                                    <div class="dots-1">
                                        <!-- SVG Dots-->
